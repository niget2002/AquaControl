...
#define tankTempHigh  27  //in Celsius 80.6F
#define tankFanHigh 26.5 //in Celsius 79.7F This will turn the fan on before using the chiller as backup
...
void analogCheck(void) {
  ...
  // We now have cooling fans on the tank. Let's turn them
  // on and off based on tank temperature
